...
from system_1.discovery_controls import discovery_enabled, validate_scheduler_environment
...
def submit_daily_discovery_providers_activity(input_data: dict[str, str]) -> dict[str, str]:
    ...
    policy = replace(
        ...
        apify_max_cost_usd=Decimal(environment["SYSTEM1_DISCOVERY_MAX_APIFY_USD"]),
        outscraper_max_cost_usd=Decimal(environment["SYSTEM1_DISCOVERY_MAX_OUTSCRAPER_USD"]),
    )
