...
description: "A comprehensive marketing skill bundle covering 33 specialized areas. Use this skill whenever the user asks about any marketing topic including: A/B testing, ad creative, AI SEO, analytics tracking, churn prevention, cold email, competitor pages, content strategy, copywriting, copy editing, email sequences, CRO (forms, pages, popups, signup, onboarding, paywalls), free tools, launch strategy, lead magnets, marketing ideas, marketing psychology, paid ads, pricing strategy, programmatic SEO, referral programs, RevOps, sales enablement, schema markup, SEO audits, site architecture, social content, and product marketing context. Always use this skill before producing any marketing-related output."
---

# Marketing Skills

This skill bundles 33 specialized sub-skills. When the user's request matches one of the areas below, apply the relevant sub-skill's instructions.
...
- **churn-prevention**: When the user wants to reduce churn, build cancellation flows, set up save offers, recover failed pa...
...
- **product-marketing-context**: When the user wants to create or update their product marketing context document. Also use when the ...
- **programmatic-seo**: When the user wants to create SEO-driven pages at scale using templates and data. Also use when the ...
- **referral-program**: When the user wants to create, optimize, or analyze a referral program, affiliate program, or word-o...
- **revops**: When the user wants help with revenue operations, lead lifecycle management, or marketing-to-sales h...
...
- **site-architecture**: When the user wants to plan, map, or restructure their website's page hierarchy, navigation, URL str...
- **social-content**: When the user wants help creating, scheduling, or optimizing social media content for LinkedIn, Twit...

---

## SUB-SKILL: ab-test-setup
...
## SUB-SKILL: competitor-alternatives
...
## SUB-SKILL: marketing-psychology
...
## SUB-SKILL: product-marketing-context
